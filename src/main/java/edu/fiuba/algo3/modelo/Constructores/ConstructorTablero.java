...
public class ConstructorTablero {
    ...
    private static final int[][] DEFINICION_ARISTAS = {
            ...
            {27, 34}, {34, 29}, {29, 35}, {35, 30}, {30, 36}, {36, 31}, {31, 37}, {37, 32}, {32, 38}, {38, 33}, //fila 7
            {34, 39}, {35, 40}, {36, 44}, {37, 42}, {38, 43}, //fila 8
            {39, 44}, {44, 49}, {40, 45}, {45, 41}, {41, 46}, {46, 42}, {42, 47}, {47, 43}, //fila 9
            {44, 48}, {45, 49}, {46, 50}, {47, 51}, //fila 10
            {48, 52}, {52, 49}, {49, 53}, {53, 50}, {50, 54}, {54, 51} //fila 11
    };

    private static final int[][] VERTICES_DE_TERRENO = {
                      {1, 4, 5, 8, 9, 13},   {2, 5, 6, 9, 10, 14},  {3, 6, 7, 10, 11, 15},

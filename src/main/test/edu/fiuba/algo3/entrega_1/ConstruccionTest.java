...
public class ConstruccionTest{
    ...
    public void test01ElPobladoGeneraUnSoloRecurso() {
        ...
        poblado.producirRecurso(recurso);

        assertEquals(1,jugador.cantidadRecurso(recurso));
    }
    ...
    public void test02LaCiudadGeneraDosRecursos() {
        ...
        ciudad.producirRecurso(recurso);

        assertEquals(2,jugador.cantidadRecurso(recurso));
    }
    ...
    public void test03LaCarreteraNoGeneraRecursos() {
        ...
        carretera.producirRecurso(recurso);
